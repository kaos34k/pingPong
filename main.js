...
(function(){
	...
	self.ball.prototype = {
		...
		collisions : function (bar){
			var relative_insert_y = (bar.y + (bar.height/ 2) ) - this.y;
			var normalize_insert_y = relative_insert_y / (bar.height / 2);

			this.bounce_angle = normalize_insert_y * this.max_bounce_angle;
